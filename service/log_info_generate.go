...
func GenerateMjOtherInfo(relayInfo *relaycommon.RelayInfo, priceData types.PriceData) map[string]interface{} {
	...
	InjectQiniuMarketTaskRealtimeInfo(other, priceData.QiniuMarket, priceData.OtherRatios, priceData.Quota)
	markQiniuOfficialLedgerOther(other, relayInfo, priceData.Quota)
	return other
}
