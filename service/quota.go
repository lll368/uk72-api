...
func PostWssConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelName string,
	...
	if totalTokens != 0 && !qiniuOfficialLedgerBilling && settlementApplied && !shouldUseQiniuMarketRealtimeFunding(relayInfo) {
	...
	markQiniuOfficialLedgerOther(other, relayInfo, quota)
	recordConsumeLogWithQiniuRealtimeWalletFlowWithError(ctx, relayInfo, model.RecordConsumeLogParams{
		...
		ModelName:        logModel,
		TokenName:        tokenName,
		Quota:            qiniuOfficialLedgerLogQuota(relayInfo, quota),
		Content:          logContent,
...
func PostConsumeQuota(relayInfo *relaycommon.RelayInfo, quota int, preConsumedQuota int, sendEmail bool) (err error) {
	if shouldUseQiniuOfficialLedger(relayInfo) {
		...
		relayInfo.BillingSource = qiniuOfficialLedgerBillingSource
		return nil
	}
