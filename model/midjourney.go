...
type Midjourney struct {
	...
	BillingSource  string `json:"billing_source" gorm:"type:varchar(32);default:'';index"`
	FundingSource  string `json:"-" gorm:"type:varchar(32);default:'';index"`
	SubscriptionId int    `json:"-" gorm:"default:0;index"`
