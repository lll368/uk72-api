      ...
      data.forEach((item) => {
        switch (item.key) {
          ...
          case 'payment_setting.amount_discount':
            ...
            break;
          case 'payment_setting.default_user_topup_discount':
            newInputs['DefaultUserTopupDiscount'] = parseFloat(item.value) || 1;
            break;
          case 'payment_setting.default_vvip_topup_discount':
            newInputs['DefaultVvipTopupDiscount'] = parseFloat(item.value) || 1;
            break;
          case 'payment_setting.vip_activation_price':
            newInputs['VipActivationPrice'] = parseNumberWithFallback(
              item.value,
              1680,
            );
            break;
          case 'payment_setting.vip_activation_commission_level1_amount':
            newInputs['VvipActivationCommissionLevel1Amount'] =
              parseNumberWithFallback(item.value, 1000);
            break;
          case 'payment_setting.vip_activation_commission_level2_amount':
            newInputs['VvipActivationCommissionLevel2Amount'] =
              parseNumberWithFallback(item.value, 400);
            break;
        ...
        <Card style={{ marginTop: '10px' }}>
          ...
          >
            ...
            >
              ...
              <Tabs.TabPane tab={t('支付宝直连设置')} itemKey='alipay'>
              ...
              <Tabs.TabPane tab={t('微信支付直连设置')} itemKey='wechat-pay'>
