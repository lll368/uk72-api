    ...
    <div className='px-2 pt-2'>
      <div className='grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-4'>
        {paginatedModels.map((model, index) => {
          ...
          const isQiniuMarket = isQiniuMarketModel(model);

          const priceData = isQiniuMarket
            ? null
            : calculateModelPrice({
                record: model,
                selectedGroup,
          ...
          const qiniuPriceItems = isQiniuMarket
            ? getQiniuMarketPriceDisplayItems(model, t)
            : [];
