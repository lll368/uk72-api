...
import DisableVvipModal from './modals/DisableVvipModal';
...
const UsersTable = (usersData) => {
  ...
  const [showUserSubscriptionsModal, setShowUserSubscriptionsModal] =
    useState(false);
  const [showDisableVvipModal, setShowDisableVvipModal] = useState(false);
  ...
  const showDisableVvipUserModal = (user) => {
    setModalUser(user);
    setShowDisableVvipModal(true);
  };
  ...
  const handleDisableVvipConfirm = async () => {
    await disableUserVvip(modalUser);
    setShowDisableVvipModal(false);
  };
  ...
  const columns = useMemo(() => {
    return getUsersColumns({
      ...
      showDisableVvipModal: showDisableVvipUserModal,
    });
  }, [
    t,
    setEditingUser,
  ...
  return (
    <>
      ...
      <DisableVvipModal
        visible={showDisableVvipModal}
        onCancel={() => setShowDisableVvipModal(false)}
        onConfirm={handleDisableVvipConfirm}
        user={modalUser}
        t={t}
      />
    </>
