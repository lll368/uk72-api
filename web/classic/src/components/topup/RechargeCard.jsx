...
const RechargeCard = ({
  ...
  const subscriptionMethods = subscriptionPayMethods || [];
                      ...
                      <Form.Slot label={t('选择支付方式')}>
                        <Space wrap>
                          {regularPayMethods.map((payMethod) => {
                            ...
                            const isWechatDirect = isWechatDirectPayment(
                              payMethod.type,
                            );
                            const disabled =
                              (!enableOnlineTopUp &&
          ...
          >
            <div className='py-2'>
              <SubscriptionPlansCard
                ...
                payMethods={subscriptionMethods}
