  ...
  const generateDefaultConfig = () => {
    ...
    if (isSidebarSectionAllowed('admin')) {
      defaultConfig.admin = {
        ...
        finance: isSidebarModuleAllowed('admin', 'finance'),
        contact_messages: isSidebarModuleAllowed('admin', 'contact_messages'),
    ...
    },
    {
      ...
      modules: [
        ...
        { key: 'user', title: t('用户管理'), description: t('用户账户管理') },
        {
          key: 'finance',
          title: t('财务运营'),
          description: t('管理VVIP开通、邀请关系、佣金、提现和支付审计'),
        },
        {
          key: 'contact_messages',
          title: t('留言管理'),
          description: t('查看并处理首页访客留言'),
        },
        {
          key: 'setting',
          title: t('系统设置'),
