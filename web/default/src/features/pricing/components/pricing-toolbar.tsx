...
import { ArrowDown, Check, Filter, Grid2X2, Table2 } from 'lucide-react'
...
function SegmentedControl(props: {
  ...
  return (
    <div
      ...
      className='bg-background inline-flex h-9 items-center rounded-lg border p-0.5 shadow-sm'
    >
        ...
        const button = (
          <button
            ...
            className={cn(
              ...
              Icon && !option.label ? 'w-8' : 'gap-1.5 px-3',
              isActive
...
export function PricingToolbar(props: PricingToolbarProps) {
  ...
  const displayCount = props.totalCount ?? props.filteredCount
      ...
      <div className='flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between'>
        <div className='flex items-center gap-2'>
          ...
          <p className='text-muted-foreground text-sm'>
            <Trans
              i18nKey='This site currently has {{count}} models enabled'
              values={{ count: displayCount }}
              components={[<span key='count' style={{ color: '#0F62FE' }} />]}
            />
          </p>
        </div>
