...
export function SidebarModulesCard() {
    ...
    },
    {
      ...
      modules: [
        ...
        },
        {
          ...
          description: t('Bank card commission withdrawal entry'),
        },
        {
          key: 'compute_partners',
          title: t('Compute Partners'),
          description: t('Compute partner activation and referral rewards'),
        },
        {
          key: 'subordinates',
  ...
  return (
    <Card className='gap-0 overflow-hidden py-0 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 border-purple-100'>
