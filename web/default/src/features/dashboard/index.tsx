...
import { RankingsContent } from '@/features/rankings/content'
import { resolveRankingPeriod } from '@/features/rankings/lib/period'
...
export function Dashboard() {
  ...
  const rankingsPeriod = resolveRankingPeriod(search.period)
  ...
  const visibleSections = useMemo(
    () => getVisibleDashboardSectionIds(isAdmin).filter((section) => section !== 'overview'),
    [isAdmin]
  )
  ...
  const handleRankingsPeriodChange = useCallback(
          ...
          {activeSection === 'rankings' && (
            <FadeIn>
              <RankingsContent
                ...
                onPeriodChange={handleRankingsPeriodChange}
                mode='embedded'
              />
            </FadeIn>
          )}
