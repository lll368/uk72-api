...
export function SummaryCards() {
  ...
  const items = useSummaryCardsConfig({
    ...
    // Soft pastel gradient backgrounds for each stat card slot, matching the
    // dashboard reference design (cyan/blue, violet/purple, pink/rose).
    const gradientBackgrounds = [
      'bg-linear-to-br from-sky-100 via-blue-50 to-indigo-100 dark:from-sky-950/40 dark:via-blue-950/30 dark:to-indigo-950/40',
      'bg-linear-to-br from-violet-100 via-purple-50 to-fuchsia-100 dark:from-violet-950/40 dark:via-purple-950/30 dark:to-fuchsia-950/40',
      'bg-linear-to-br from-pink-100 via-rose-50 to-pink-100 dark:from-pink-950/40 dark:via-rose-950/30 dark:to-pink-950/40',
    ] as const
    ...
    return {
      ...
      backgroundClass:
        gradientBackgrounds[index] ?? gradientBackgrounds[0],
      sparkline:
