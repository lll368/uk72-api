  ...
  > = {
    ...
    personal: {
      ...
      withdrawal: {
        ...
        description: t(
          'Allow users to submit bank card commission withdrawals.'
        ),
      },
      compute_partners: {
        title: t('Compute Partners'),
        description: t(
          'Control compute partner activation and referral rewards entry.'
        ),
      },
      subordinates: {
        title: t('Subordinate Management'),
        description: t('View invited users and adjust recharge discounts'),
      },
      personal: {
        title: t('Profile'),
    ...
    admin: {
      ...
      recharge_records: {
        ...
        description: t('admin_recharge_records_description'),
      },
      finance_withdrawals: {
        title: t('admin_withdrawals_title'),
        description: t('admin_withdrawals_description'),
      },
      redemption: {
      ...
      qiniu_keys: {
        ...
        description: t('admin_qiniu_keys_description'),
      },
      qiniu_child_accounts: {
        title: t('admin_qiniu_child_accounts_title'),
        description: t('admin_qiniu_child_accounts_description'),
      },
      rankings: {
        title: t('Rankings'),
