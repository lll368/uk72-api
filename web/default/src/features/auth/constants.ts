...
export const forgotPasswordFormSchema = z
  ...
  .refine((data) => !data.account || isValidAuthAccount(data.account), {
    message: 'Please enter a valid email or phone number',
    path: ['account'],
  })
  .refine((data) => !data.password || hasLetterAndNumber(data.password), {
    message: 'Password must contain letters and numbers',
    path: ['password'],
  })
