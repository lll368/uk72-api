...
export interface LogOtherData {
  ...
  qiniu_official_ledger_pending?: boolean
  qiniu_realtime_billing_skipped?: boolean
  qiniu_official_ledger_log?: boolean
  price_source?: string
  qiniu_market_billing_mode?: string
  qiniu_market_model_id?: string
  qiniu_market_rule_index?: number
  qiniu_market_input_unit_name?: string
  qiniu_market_input_unit_size?: number
  qiniu_market_input_unit_price?: number
  qiniu_market_input_currency?: string
  qiniu_market_output_unit_name?: string
  qiniu_market_output_unit_size?: number
  qiniu_market_output_unit_price?: number
  qiniu_market_output_currency?: string
  qiniu_market_unit_detail_key?: string
  qiniu_market_unit_name?: string
  qiniu_market_unit_size?: number
  qiniu_market_unit_price?: number
  qiniu_market_unit_currency?: string
  qiniu_market_unit_quantity?: number
  qiniu_market_amount_to_quota_rate?: number
  qiniu_market_group_ratio?: number
  qiniu_market_rounding_mode?: string
  qiniu_market_catalog_state?: string
  qiniu_market_catalog_stale?: boolean
  qiniu_market_catalog_from_cache?: boolean
  qiniu_market_input_tokens?: number
  qiniu_market_output_tokens?: number
  qiniu_market_amount?: number
  qiniu_market_converted_quota?: number
  qiniu_market_usage_missing?: boolean
  qiniu_official_usage_record_id?: number
  qiniu_official_ledger_id?: number
  bucket_id?: number
  billing_date?: string
