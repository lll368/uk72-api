...
// ============================================================================
// VVIP Status Configuration
// ============================================================================

export const VVIP_STATUS = {
  ACTIVE: 'active',
  DISABLED: 'disabled',
  NONE: 'none',
} as const

export const VVIP_STATUSES = {
  [VVIP_STATUS.ACTIVE]: {
    labelKey: 'VVIP Active',
    value: VVIP_STATUS.ACTIVE,
    variant: 'warning' as const,
    icon: Crown,
  },
  [VVIP_STATUS.DISABLED]: {
    labelKey: 'VVIP Disabled',
    value: VVIP_STATUS.DISABLED,
    variant: 'neutral' as const,
    icon: Crown,
  },
  [VVIP_STATUS.NONE]: {
    labelKey: 'Non-VVIP',
    value: VVIP_STATUS.NONE,
    variant: 'neutral' as const,
    icon: User,
  },
} as const

export const getVvipStatusOptions = (t: (key: string) => string) => [
  { label: t('VVIP Active'), value: VVIP_STATUS.ACTIVE, icon: Crown },
  { label: t('VVIP Disabled'), value: VVIP_STATUS.DISABLED, icon: Crown },
  { label: t('Non-VVIP'), value: VVIP_STATUS.NONE, icon: User },
]
