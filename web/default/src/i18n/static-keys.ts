...
export const STATIC_I18N_KEYS = [
  ...
  'admin_qiniu_child_accounts_title',
  'admin_qiniu_child_accounts_description',
  'VVIP Activations',
  'Relations',
  'Commissions',
  'Withdrawals',
  ...
  'Review one-time paid VVIP activation records',
  'No VVIP activation records found',
  'Disable VVIP',
  'Disable this user VVIP status and invalidate pending activation orders.',
  'Review and adjust VVIP invitation relations',
  'Bind Relation',
  'Bind a child user to an active paid VVIP parent.',
  'Disable Relation',
  'Disable this invitation relation while keeping its history.',
  ...
  'Create and review local payment reconciliation tasks',
  'Create Reconciliation Task',
  'Paste provider payment orders as a JSON array.',
  ...
  'Resolved',
  'Manual resolved',
  'Delayed billing settlement',
  'Token/model consumption',
  'Official synchronized consumption',
  'Withdrawal freeze',
  'Withdrawal paid',
  'Withdrawal rejected',
  'Refund reversal',
