...
const (
	...
	MsgUserPhoneVerificationFrequent = "user.phone_verification_frequent"
	MsgUserPhoneVerificationTooMany  = "user.phone_verification_too_many"
	MsgUserPhoneVerificationSendFail = "user.phone_verification_send_failed"
	MsgUserPhoneVerificationExpired  = "user.phone_verification_expired"
	MsgUserPhoneVerificationAttempts = "user.phone_verification_attempts"
...
// User relation related messages
const (
	MsgUserRelationInvalidStatus        = "user_relation.invalid_status"
	MsgUserRelationInvalidUserId        = "user_relation.invalid_user_id"
	MsgUserRelationSelfBinding          = "user_relation.self_binding"
	MsgUserRelationAlreadyBound         = "user_relation.already_bound"
	MsgUserRelationCycle                = "user_relation.cycle"
	MsgUserRelationParentMustActiveVvip = "user_relation.parent_must_active_vvip"
	MsgUserRelationUserNotAvailable     = "user_relation.user_not_available"
)
