...
func SetupContextForToken(c *gin.Context, token *model.Token, parts ...string) error {
	...
	common.SetContextKey(c, constant.ContextKeyTokenProvider, token.Provider)
	common.SetContextKey(c, constant.ContextKeyQiniuManagedToken, token.IsQiniuManaged())
