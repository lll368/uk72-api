...
func TestHeaderNavModuleAuthRejectsUnauthenticatedForRankingsWithRequireAdmin(t *testing.T) {
	raw := `{"rankings":{"enabled":true,"requireAdmin":true}}`
	withHeaderNavModules(t, raw)
...
func TestHeaderNavModuleAuthRejectsNonAdminForRankings(t *testing.T) {
	raw := `{"rankings":{"enabled":true,"requireAdmin":true}}`
	withHeaderNavModules(t, raw)
...
func TestHeaderNavModuleAuthAllowsAdminForRankings(t *testing.T) {
	raw := `{"rankings":{"enabled":true,"requireAdmin":true}}`
	withHeaderNavModules(t, raw)

	recorder := performHeaderNavRequestWithRole(t, HeaderNavModuleAuth("rankings"), common.RoleAdminUser)
	require.Equal(t, http.StatusOK, recorder.Code)
}

func TestHeaderNavModuleAuthAllowsAllForRankingsWithoutRequireAdmin(t *testing.T) {
	raw := `{"rankings":{"enabled":true}}`
	withHeaderNavModules(t, raw)
...
func TestHeaderNavModuleAuthAllowsUnauthenticatedForRankingsWithoutRequireAdmin(t *testing.T) {
	raw := `{"rankings":{"enabled":true,"requireAuth":false}}`
	withHeaderNavModules(t, raw)
