...
func genBaseRelayInfo(c *gin.Context, request dto.Request) *RelayInfo {
	...
	info := &RelayInfo{
		...
		TokenProvider:     common.GetContextKeyString(c, constant.ContextKeyTokenProvider),
		TokenUnlimited:    common.GetContextKeyBool(c, constant.ContextKeyTokenUnlimited),
		QiniuManagedToken: common.GetContextKeyBool(c, constant.ContextKeyQiniuManagedToken),
